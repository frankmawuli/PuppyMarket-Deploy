                    ...
                    <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
                        <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
                            ...
                            <div className="space-y-3">
                                ...
                                <h1 className="text-xl font-semibold text-gray-700 capitalize">Elegant Design</h1>
                            ...
                            <div className="space-y-3">
                                ...
                                <h1 className="text-xl font-semibold text-gray-700 capitalize">Easy to Customize</h1>
